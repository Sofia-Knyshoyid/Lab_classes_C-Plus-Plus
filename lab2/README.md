...
---------
Klasa `MacOS`:
1. Jako punkt z aktywnosci można zaimplementować klasę `MacOs` analogicznie jak dla pozostałych systemów (oczywiście jeśli ktoś nie zdobył maks na tych zajęciach)
